					...
					<div className='flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8'>
						<div className='max-w-3xl w-full space-y-8'>
							...
							<p class="font-serif">
								...
								เป็นแอปพลิเคชั่นที่พัฒนาเพื่อช่วยเหลือในการเก็บข้อมูลจากผู้เข้าร่วมวิจัยใน
								"โครงการ R016241035" (ต่อจากนี้จะแทนว่า "งานวิจัย")
							...
							<ul>
								...
								<li class="font-serif list-disc leading-7	">ชื่อ-นามสกุลของท่าน</li>
								...
								<li class="font-serif list-disc leading-7	">ชื่อ-นามสกุลและชื่อเล่นของเด็กในการดูแลหรือบุตรของท่าน</li>
								<li class="font-serif list-disc leading-7	">วันเกิดของเด็กในการดูแลหรือบุตรของท่าน</li>
								<li class="font-serif list-disc leading-7	">
									...
									<ul class="pl-5">
										...
										<li class="font-serif list-disc leading-7	">อาการที่เกิดขึ้น ณ เวลาที่รายงาน</li>
										<li class="font-serif list-disc leading-7	">รูปภาพประกอบอาการที่เกิดขึ้น</li>
										<li class="font-serif list-disc leading-7	">
											ในกรณีที่มีการพบแพทย์และได้รายงาน จะมีข้อมูลที่เก็บเพิ่ม
											ดังนี้:
											<ul class="pl-5">
												<li class="font-serif list-disc leading-7	">โรคที่แพทย์ได้วินิจฉัย</li>
												<li class="font-serif list-disc leading-7	">วันที่และสถานที่ที่ได้พบแพทย์</li>
											</ul>
										</li>
									</ul>
								</li>
							...
							<h3 class="text-lg font-bold">เราแบ่งปันข้อมูลของคุณให้ใครบ้าง</h3>
							<p class="font-serif">
								แอปพลิเคชั่น HFMD
